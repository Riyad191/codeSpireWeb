            ...
            <div>
              <div
                style={{
                  height: 40,
                  background:
                    "linear-gradient(rgba(255, 255, 255, 0.157), red)",
                  textAlign: "center",
                }}
              ></div>
            ...
            <div className="coursesPage">
              ...
              <div className="materials">
                <div className="material">
                  ...
                  <div id="materialInfo">
                    <p>
                      In 16 weeks, learn to code responsive web applications
                      using HTML, CSS, JavaScript and JavaScript frameworks like
                      Angular and React.
                    </p>
                  </div>
                ...
                <div className="material">
                  ...
                  <div id="materialInfo">
                    <p>
                      {" "}
                      In 20 weeks, learn to code in JAVA and Cloud Computing
                      with AWS to manage and store app data.
                    </p>
                  </div>
